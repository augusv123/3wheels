...
rgen.global_validation = {
	...
	successMsg : "<div class='msg-success alert alert-success' role='alert'>Gracias por enviarnos su consulta. A la brevedad le responderemos.</div>",
	errorMsg   : "<div class='msg-error alert alert-danger' role='alert'>Error en el envio, por favor envíe un email a info@3wheels.com.ar.</div>"
}
