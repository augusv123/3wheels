...
#accesosDirectos,#cabeceraClientes{
    display: none;
}
...
<body>
    ...
    <div class="sidebar-menu">
        <ul class="menu">
            ...
            <li class="sidebar-item  has-sub  <?php if (str_contains($_SERVER['PHP_SELF'], 'reservas')){echo "active";}?>">
            ...
            <li
                class="sidebar-item <?php if (str_contains($_SERVER['PHP_SELF'], 'clientes')){echo "active";}?> ">
            ...
            <li class="sidebar-item <?php if (str_contains($_SERVER['PHP_SELF'], 'tarifarios')){echo "active";}?> ">
                <a href="tarifarios.php" class='sidebar-link'>
                    <i class="bi bi-file-earmark-spreadsheet-fill"></i>
                    <span>Tarifarios</span>
                </a>
            </li>
            <li class="sidebar-item <?php if (str_contains($_SERVER['PHP_SELF'], 'mindiasreserva')){echo "active";}?> ">
                <a href="mindiasreserva.php" class='sidebar-link'>
                    <i class="bi bi-file-earmark-spreadsheet-fill"></i>
                    <span>Minimo dias reserva</span>
                </a>
            </li>
            <li class="sidebar-item <?php if (str_contains($_SERVER['PHP_SELF'], 'factor_dias')){echo "active";}?> ">
                <a href="factor_dias.php" class='sidebar-link'>
                    <i class="bi bi-file-earmark-spreadsheet-fill"></i>
                    <span>Factor dias</span>
                </a>
            </li>
            <li class="sidebar-item <?php if (str_contains($_SERVER['PHP_SELF'], 'lugares_de_retiro')){echo "active";}?> ">
                <a href="lugares_de_retiro.php" class='sidebar-link'>
                    <i class="bi bi-geo"></i>
                    <span>Lugares de retiro</span>
                </a>
            </li>
            <li class="sidebar-item <?php if (str_contains($_SERVER['PHP_SELF'], 'cotizador.php')){echo "active";}?> ">
   ...
   <li class="sidebar-item <?php if (str_contains($_SERVER['PHP_SELF'], 'autos')){echo "active";}?> ">
            ...
            <li class="sidebar-item <?php if (str_contains($_SERVER['PHP_SELF'], 'activar')){echo "active";}?> ">
